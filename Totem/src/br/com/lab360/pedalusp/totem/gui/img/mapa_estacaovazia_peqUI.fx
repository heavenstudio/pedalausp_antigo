 ...
 * mapa_estacaovazia_peqUI.fx
 *
 * Created on Wed Mar 17 12:29:14 BRT 2010
 */
...
public class mapa_estacaovazia_peqUI extends FXDNode {
	
	override public var url = "{__DIR__}mapa_estacaovazia_peq.fxz";
