 ...
 * mapa_estacaovaziaUI.fx
 *
 * Created on Wed Mar 24 12:08:17 BRT 2010
 */
...
public class mapa_estacaovaziaUI extends FXDNode {
	
	override public var url = "{__DIR__}mapa_estacaovazia.fxz";
