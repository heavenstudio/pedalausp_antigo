 ...
 * mapa_estacaolotada_peqUI.fx
 *
 * Created on Tue Mar 16 19:50:09 BRT 2010
 */
...
public class mapa_estacaolotada_peqUI extends FXDNode {
	
	override public var url = "{__DIR__}mapa_estacaolotada_peq.fxz";
