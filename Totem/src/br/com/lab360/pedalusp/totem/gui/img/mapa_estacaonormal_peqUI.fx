 ...
 * mapa_estacaonormal_peqUI.fx
 *
 * Created on Wed Mar 17 12:29:07 BRT 2010
 */
...
public class mapa_estacaonormal_peqUI extends FXDNode {
	
	override public var url = "{__DIR__}mapa_estacaonormal_peq.fxz";
